...
{summary}"""
    ...
    def _generate_recommendation(self, data: dict[str, Any]) -> str:
        """生成建议部分"""
        recommendation = data.get("recommendation", data.get("details", {}).get("recommendation"))
...
{reason}"""
    ...
    def _generate_technical_analysis(self, data: dict[str, Any]) -> str:
        """生成技术分析"""
        technical = data.get("technical_analysis", data.get("details", {}).get("technical", {}))
        if not technical:
            return ""
    ...
    def _generate_opportunities(self, data: dict[str, Any]) -> str:
        """生成机会分析"""
        opportunities = data.get("opportunities", data.get("details", {}).get("opportunities", []))
    ...
    def _generate_trading_advice(self, data: dict[str, Any]) -> str:
        """生成交易建议"""
        advice = data.get("trading_advice", data.get("details", {}).get("trading_advice", {}))
        if not advice:
            return ""
